    ...
    <div className="bg-black text-white min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-zinc-950 border border-zinc-900 p-10 rounded shadow-2xl animate-in slide-in-from-bottom-8 duration-700">
        ...
        <form className="space-y-6">
          ...
          <button className="w-full bg-red-600 hover:bg-red-700 text-white py-4 font-black uppercase italic tracking-widest text-xs transition-all flex items-center justify-center group">
